...
public partial class Client_Default : System.Web.UI.Page
{
    ...
    public void Getminmaxprice()
    {
        try
        {
            MinPrice = float.Parse(Request.QueryString["Min"]);
            MaxPrice = float.Parse(Request.QueryString["Max"]);
        }
        catch (Exception ex)
        {
            Response.Write("<script type=\"text/javascript\">alert('" + ex.Message + "')</script>");
    ...
    public string ReturnProduct()
    {
        ...
        DataTable dt4 = ProductFunctions.Return_Sorted_ProductsViaPrice(sorttype, (int)countshowitem, startindex,MinPrice,MaxPrice);
