<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminpanel.master" AutoEventWireup="true" CodeFile="PageAdd.aspx.cs" Inherits="Admin_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">
    <table style="width:100%;" border=1>
        ...
        <tr>
            ...
            <td style="width: 221px">
             <CKEditor:CKEditorControl ID="CKEditorPageBody" BasePath="~/ckeditor/" runat="server"></CKEditor:CKEditorControl>
        ...
        <tr>
            <td style="margin-left: 160px; text-align: right; width: 157px;">
                <asp:Button ID="btnsave" runat="server" onclick="btnsave_Click" 
                    style="text-align: right" Text="Save" />
            </td>
