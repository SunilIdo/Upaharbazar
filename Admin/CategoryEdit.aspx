<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminpanel.master" AutoEventWireup="true" CodeFile="CategoryEdit.aspx.cs" Inherits="Admin_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" Runat="Server">
    <p>
        ...
        <tr>
            ...
            <td rowspan="6">
                <asp:Image ID="imgcategory" runat="server" Height="169px" Width="186px" />
            </td>
        </tr>
        <tr>
            <td style="width: 157px">
