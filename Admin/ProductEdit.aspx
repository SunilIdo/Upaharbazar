<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminpanel.master" AutoEventWireup="true" CodeFile="ProductEdit.aspx.cs" Inherits="Admin_Default" %>
    ...
    <p>
        ...
        <tr>
            <td style="width: 160px">
                <asp:Label ID="Label13" runat="server" Font-Bold="True" Text="Update Product"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td rowspan="5">
                <asp:Image ID="imgproduct" runat="server" Height="157px" Width="171px" />
            </td>
        </tr>
        <tr>
            <td style="width: 160px">
